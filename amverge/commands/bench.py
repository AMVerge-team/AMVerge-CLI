...
def bench(
    ...
    with make_progress(transient=True) as progress:
        ...
        t0 = time.perf_counter()
        from ..core.probe_utils import probe_video_duration, probe_video_fps
    ...
    if not skip_ml:
        try:
            ...
            with make_progress(transient=True) as progress:
                ...
                t0 = time.perf_counter()
                from ..core.scene_detection import decode_video_frames_nelux
                try:
                    ...
                    with make_progress(transient=True) as progress2:
                        ...
                        t0 = time.perf_counter()
                        from ..core.scene_detection import run_model_one_pass
