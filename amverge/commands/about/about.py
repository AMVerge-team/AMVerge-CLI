...
def about() -> None:
    ...
    t.add_row("Smart cut",            "lossless copy for any scene near a keyframe (edit-list trimmed), re-encode otherwise")
    t.add_row("HEVC support",         "same lossless-copy path as H.264, no separate case")
